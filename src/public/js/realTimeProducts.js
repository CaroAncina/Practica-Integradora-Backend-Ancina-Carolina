    ...
    if (userRole === 'admin') {
        ...
        if (btnActualizar) {
            btnActualizar.addEventListener('click', (e) => {
                ...
                const producto = { id, title, description, price, code, stock, category, thumbnail };
    ...
    socket.on('productos', (productos) => {
        ...
        productos.forEach(producto => {
            ...
            productoElement.innerHTML = `
                ...
                ${userRole === 'admin' ? `<button onclick="editarProducto('${producto._id}')">Editar</button><button onclick="eliminarProducto('${producto._id}')">Eliminar</button>` : ''}
            `;
